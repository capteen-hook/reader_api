...
export async function POST(req: Request) {
  try {
    ...
    console.log("Uploading to", process.env.READER_API + "/process/appliance");

    const response = await fetch(process.env.READER_API + "/process/appliance", {
      method: "POST",
    ...
    console.error("Error in POST /appliance:", error);
